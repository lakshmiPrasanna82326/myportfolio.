    ...
    <div>
      <section className="home-class flex h-[100vh] " id="home">
        <div className="flex-column relative mt-[320px] m-[10px] w-[100%] " id="home-details">
          ...
          <a href="Resume.pdf" download="LakshmiPrasanna.">
           ...
           {/* <a
            ...
            <a className="m-10 bg-black white text-white px-3 py-0.5 rounded-md w-24 border-2 border-white hover:bg-white hover:text-black"  href="#footer" >Contact</a>
